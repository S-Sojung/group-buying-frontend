...
final userBoardlistPageProvider = StateNotifierProvider<UserBoardlistPageViewModel, UserBoardlistPageModel?>((ref) {
  SessionUser sessionUser = ref.read(sessionProvider);
  return UserBoardlistPageViewModel(null)..notifyInit(sessionUser.jwt!);
...
class UserBoardlistPageModel{
  MyPageBoard myPageBoard;
  UserBoardlistPageModel({required this.myPageBoard});
}


//창고 : Store
class UserBoardlistPageViewModel extends StateNotifier<UserBoardlistPageModel?>{
  UserBoardlistPageViewModel(super.state);
  ...
  void notifyInit(String jwt) async{
    ...
    state = UserBoardlistPageModel(myPageBoard: dto);
  }
